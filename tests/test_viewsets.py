...
class TestGetChangeViewSet:
    ...
    def test_get_default():
        ...
        assert book_change_viewset.lookup_url_kwarg == 'uid'
...
class TestGetSnapshotViewSet:
    ...
    def test_get_default():
        ...
        assert book_snapshot_viewset.lookup_url_kwarg == 'uid'
...
class TestGetChangeAttachmentViewSet:
    ...
    def test_get_default():
        ...
        assert book_change_attachment_viewset.lookup_url_kwarg == 'uid'
